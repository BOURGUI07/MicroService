...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDTO> handleResourceNotFoundException(EntityNotFoundException ex, WebRequest request) {
        ...
        var errorResponse = new ErrorResponseDTO(request.getDescription(false),HttpStatus.NOT_FOUND, HttpStatus.NOT_FOUND.value(), ex.getMessage(), System.currentTimeMillis());
    ...
    public ResponseEntity<ErrorResponseDTO> handleGeneralException(Exception ex, WebRequest request) {
        ...
        var errorResponse = new ErrorResponseDTO(request.getDescription(false),HttpStatus.INTERNAL_SERVER_ERROR,HttpStatus.INTERNAL_SERVER_ERROR.value(), ex.getMessage(), System.currentTimeMillis());
    ...
    public ResponseEntity<ErrorResponseDTO> handleValidationException(ConstraintViolationException ex, WebRequest request) {
        ...
        var errorResponse = new ErrorResponseDTO(request.getDescription(false),HttpStatus.BAD_REQUEST,HttpStatus.BAD_REQUEST.value(), errorMessage, System.currentTimeMillis());
